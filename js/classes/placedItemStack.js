...
class PlacedItemStack {
  ...
  placeAt = (nx, ny) => {
    ...
    if (tileMapData.map[toIndex(this.x, this.y)].itemStack === this) {
      tileMapData.map[toIndex(this.x, this.y)].itemStack = null;
    }
    ...
    tileMapData.map[toIndex(nx, ny)].itemStack = this;
  };
}
